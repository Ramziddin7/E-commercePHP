  ...
  <!-- begining container -->
   ...
   <!-- ending navbar -->
    ...
    <h3 class="text-center text-primary mb-3">View</h3>
       <a  href="index.php" class="btn btn-success my-3">Back</a>     
    <?
      $product_id = $_POST['id'];
      ...
      <div class="row my-pd-5">    
                ...
                <div class="col-12 col-sm-12 col-md-6">
                    ...
                    <div class="card  border-success mb-3" style="max-width: 18rem;">
                        ...
                        <div class="card-header bg-transparent border-success"><a href="tel:<?=$user['phone'];?>" class="card-text"><?=$user['phone'];?></a></div>
                    </div>  
                </div>     
            </div>
        </div>
